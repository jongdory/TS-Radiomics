...
from model.VQGAN_monai.vqvae import VQVAE
...
class LatentBrownianBridgeModel(BrownianBridgeModel):
    def __init__(self, model_config):
        ...
        if self.condition_key == 'nocond':
            ...
            self.cond_stage_model = nn.Identity() #nn.Linear(model_config.radiomics_dim, model_config.BB.params.UNetParams.context_dim)
        else:
